...
It is used for MPS3/MPS4 FPGA and for Fast Model environment.

> **NOTE**: All Arm® Corstone™-300 based platform implementations fully support the use of `timing adapter` to perform
> bandwidth/latency sweeps for performance estimation of the Arm® Ethos™-U NPUs. However, the timing adapter implementations
> in Arm® Corstone™-310 and Arm® Corstone™-315 are different and unsuitable for such benchmarking. See
...
> CMake configuration is set up to ignore the timing adapters, if any, entirely for Arm® Corstone™-310 and Arm® Corstone™-315.
> If you want to do any NPU performance benchmarking for different bandwidth and latency conditions,
> we recommend using the Arm® Corstone™-300 and Arm® Corstone™-320 implementations.
