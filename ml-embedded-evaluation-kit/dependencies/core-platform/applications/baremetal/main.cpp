...
__attribute__((section(".bss.tensor_arena"), aligned(32))) uint8_t TFLuTensorArena[tensorArenaSize];
...
int runInference() {
    ...
    LOG("Status of executed job: ");
    LOG(failed ? "Failed\n" : "Success\n");
    LOG("Performance monitor merge count %zu\n", ethosuMonitor.getMergeCount());
