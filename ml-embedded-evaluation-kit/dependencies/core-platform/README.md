...
[core_software](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-core-software)
repository.
...
# Arm(R) Corstone(TM)-310

The
[Arm(R) Corstone(TM)-310](https://developer.arm.com/Processors/Corstone-310)
is a reference design of how to to build a secure System on Chip (SoC). A fixed
virtual platform (FVP) of the Arm Corstone-310 including the Arm Ethos-U can be
downloaded from the Ecosystem page at
[developer.arm.com](https://developer.arm.com/tools-and-software/open-source-software/arm-platforms-software/arm-ecosystem-fvps).
Once installed, make sure to add the path of the FVP executables to your PATH
environment variable.

# Arm(R) Corstone(TM)-315

The
[Arm(R) Corstone(TM)-315](https://developer.arm.com/Processors/Corstone-315)
is a reference design of how to to build a secure System on Chip (SoC). A fixed
virtual platform (FVP) of the Arm Corstone-315 including the Arm Ethos-U can be
downloaded from the Ecosystem page at
[developer.arm.com](https://developer.arm.com/tools-and-software/open-source-software/arm-platforms-software/arm-ecosystem-fvps).
Once installed, make sure to add the path of the FVP executables to your PATH
environment variable.
...
## Compiler options used for security and warnings

The options discussed below are applicable only to the Arm Ethos-U core platform
component. Other components may override these flags or append to them. Please
refer to the compiler options specified in the respective CMake files for
that component.

### GNU Compiler Collection (GCC)

The following compiler options are enabled for the GCC compiler. Please refer
to the GCC documentation for more information about each option.
...
###  Arm(R) Compiler for Embedded (armclang)

The following compiler options are enabled for the armclang compiler. Please refer
to the armclang documentation for more information about each option.
...
can be found in
[pmu_ethosu.h](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-core-driver/-/blob/main/include/pmu_ethosu.h?ref_type=heads)
...
Note that Corstone-310 and Corstone-315 does not contain timing adapters on the
NPU AXI interfaces.
...
Applications for the Corstone-315 FVP are built and tested similarly to the
Corstone-310. The Corstone-315 FVP contains a Cortex-M85 CPU and Ethos-U65 NPU.
Note that Corstone-315 does not contain timing adapters on the NPU AXI interfaces,
thus this platform might not be suitable for performance measurements.

```
$ cmake -B build targets/corstone-315
$ cmake --build build
```

Assuming the `FVP_Corstone_SSE-315` executable can be found via the PATH
variable, the unit tests can be executed with `ctest`.
...
Assuming the `FVP_Corstone_SSE-320` executable can be found via the PATH
variable, the unit tests can be executed with `ctest`.
...
## Model and arena in flash/DRAM (Ethos-U65/U85 only)
...
[Vela](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-vela) will add
...
is declared in
[ethosu_config_u55.h](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-core-driver/-/blob/main/src/ethosu_config_u55.h?ref_type=heads)
or
[ethosu_config_u65.h](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-core-driver/-/blob/main/src/ethosu_config_u65.h?ref_type=heads)
...
[ethosu_config_u85.h](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-core-driver/-/blob/main/src/ethosu_config_u85.h?ref_type=heads)
...
The weak functions can be found in
[ethosu_driver.c](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-core-driver/-/blob/main/src/ethosu_driver.c?ref_type=heads#L150).
An example based on FreeRTOS how to override and implement these functions can
be found in
[applications/freertos/main.cpp](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-core-platform/-/blob/main/applications/freertos/main.cpp?ref_type=heads).
...
[core_platform](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-core-platform)
